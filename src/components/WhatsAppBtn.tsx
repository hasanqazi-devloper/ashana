...
const WhatsAppBtn = () => {
  ...
  const message = "Hi High Raise Digital, Assalamualiukum! I have a query regarding your SEO course. Can you please assist me?"; // 👈 Apna default message yahan likhein
